...
public class ItemDTO {
	...
	* This method is used to validate item.
	* 
	* @param item
	* @param action
	* 
	...
	**/
	public ArrayList<String> validateItem(Item item, String action){
		...
		if(action.equals("update")){
			...
			if(!item.getDescription().equals("") && item.getDescription().length() > 200){
				errors.add("Description can't be greater than 200 letters.");
			}
